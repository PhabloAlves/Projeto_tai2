...
class AgendamentosController extends Controller
{
    public function index()
    {
        ...
        $agendamentos = Agendamentos::join('funcionarios', 'funcionarios.id', 'agendamentos.funcionarios_id')
            ->join('servicos', 'servicos.id', 'agendamentos.servicos_id')
            ->where('agendamentos.empresas_id', $empresa->id)
            ->select(
                'agendamentos.id',
                'agendamentos.data',
                'agendamentos.status',
        ...
        foreach ($agendamentos as &$agendamento) {
            ...
            $agendamento->dataAg = $agendamento->data->format('d/m/Y');
            $agendamento->horaInicio = $agendamento->hora_inicio->format('H:i');
            $agendamento->horaFim = $agendamento->hora_fim->format('H:i');
        }
